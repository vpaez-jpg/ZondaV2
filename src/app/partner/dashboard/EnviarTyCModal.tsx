...
export default function EnviarTyCModal({ nombrePartner, onClose }: Props) {
  // Datos del cliente
  ...
  async function handleEnviar() {
    ...
    setCargando(true)
    try {
      const res = await fetch('/api/generar-propuesta-tyc', {
        method: 'POST',
    ...
    return (
      <div className="space-y-4">
        <div className="text-center py-2">
          ...
          <p className="text-sm font-semibold text-foreground">Propuesta de TyC creada</p>
        ...
        <div className={cn(
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">El cliente podrá solicitar una reunión para revisar los Términos y Condiciones</p>
            </div>
          </button>
        ...
        {showReunionInfo && (
          <div className="border border-border rounded-xl p-4 bg-muted/30 space-y-2">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Puede ofrecer al cliente una reunión virtual en la que el equipo de ZONDA explicará el contenido y la forma de utilización de sus Términos y Condiciones una vez redactados. Esta reunión es complementaria al servicio y no tiene costo adicional para el cliente ni para usted.
            </p>
            <p className="text-xs text-muted-foreground leading-relaxed">
