// GET  /api/cliente/casos/[id]/mensajes — lista mensajes del caso (vista cliente)
// POST /api/cliente/casos/[id]/mensajes — envía un mensaje como cliente
...
export async function GET(
  ...
  // Marcar como leídos los mensajes del partner que el cliente no leyó
  await supabase
    .from('caso_mensajes')
    .update({ leido: true })
    .eq('caso_id', id)
    .eq('autor_rol', 'partner')
    .eq('leido', false)
